...
import RatingImg from '../assets/images/rating_img.png'
import RatingImgGray from '../assets/images/rating_img_gray.png'
import arnoldPressGif from '../assets/images/ArnoldPress.gif'
import backSquatsGif from '../assets/images/BackSquats.gif'
import barbellRowGif from '../assets/images/BarbellRow.gif'
import shoulderPressStandingGif from '../assets/images/BarbellShoulderPress.gif'
import benchPressGif from '../assets/images/BenchPress.gif'
import squatBulgarianSplitBarGif from '../assets/images/BulgarianSquats.gif'
import cableAbCrunchesGif from '../assets/images/CableAbCrunches.gif'
import cablePushdownsGif from '../assets/images/CablePushdowns.gif'
import cableTricepKickbacksGif from '../assets/images/CableTricepKickback.gif'
import ropeUprightRowGif from '../assets/images/CableUprightRow.gif'
import cableWoodChopsGif from '../assets/images/CableWoodChops.gif'
import calfPressGif from '../assets/images/CalfPress.gif'
import chestSupportedRearDeltRowGif from '../assets/images/ChestSupportedRearDeltRow.gif'
...
import omniGripLatPulldownsGif from '../assets/images/OmniGripLatPulldowns.gif'
...
export {
    ...
    backSquatsGif,
    barbellRowGif,
    shoulderPressStandingGif,
    benchPressGif,
    squatBulgarianSplitBarGif,
    cableAbCrunchesGif,
    cablePushdownsGif,
    cableTricepKickbacksGif,
    ropeUprightRowGif,
    cableWoodChopsGif,
    calfPressGif,
    chestSupportedRearDeltRowGif,
    ...
    egyptianLateralRaisesGif,
    elevatedTrianglePushUpsGif,
    enhancedEccentricEzBarCurlGif,
    enhancedSeatedSingleLegPullGif,
    ezBarbellCurlGif,
    frontSquatsGif,
    gluteHamRaisesGif,
    hammerCurlGif,
    inclineCableFlyGif,
    inclinedBarbellBenchPressGif,
    inclinedDumbbellCurlGif,
    inclinedDumbbellOverheadExtensionGif,
    isometricDumbbellChestHoldGif,
    kneelingLatPullInGif,
    latPulldownsGif,
    leanAwayLateralRaiseGif,
    machineSeatedHipAbductionGif,
    machineShoulderPressGif,
    meadowsRowGif,
    barbellCurlNarrowGripGif,
    omniGripLatPulldownsGif,
    oneArmCableFlyGif,
    overheadCableTricepsExtensionGif,
    overheadPressGif,
    pausedFlatDumbbellPressGif,
    preacherCurlsGif,
    pullUpsGif,
    rackPullGif,
    reverseCrunchGif,
    reverseDumbbellCurlsGif,
    reversePecDeckGif,
    reverseWristCurlsGif,
    romanianDeadliftGif,
    ropeFacePullGif,
    seatedSingleLegCurlGif,
    dumbbellRowSingleGif,
    singleLegCalfPressGif,
    singleLegExtensionGif,
    snatchGripBarbellShrugGif,
    splitSquatGif,
    standingCalfRaiseGif,
    standingSingleCalfRaiseGif,
    suitcaseHoldGif,
    walkingLungesGif,
    wideCablePullOverGif,
    wristCurlsGif
}