...
import shoulderPressSeated from "./exercise-objects/shoulder-press-seated"
...
import dumbbellRowSingle from "./exercise-objects/dumbbell-row-single"
...
export default [
    ...
    hipAbductionsSeated,
    hipThrustBar,
    legCurlSeatedEccentric,
    squatBulgarianSplitBar,
    squatGobletEccentric,
    benchPress,
    cablePushdowns,
    egyptianLateralRaises,
    inclineCableFly,
    isometricDumbbellChestHold,
    ropeFacePull,
    shoulderPressSeated,
    shoulderPressStanding,
    barbellCurlNarrowGrip,
    barbellRow,
    chestSupportedRearDeltRow,
    dumbbellRowSingle,
    facePullsKneeling,
    facePullsLying,
    latPulldowns,
